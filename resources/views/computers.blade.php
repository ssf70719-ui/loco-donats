      ...
      <div class="header_section haeder_main">
         <div class="container-fluid">
            <nav class="navbar navbar-light bg-light justify-content-between">
               ...
               <a class="navbar-brand" href="index.html"><img src="{{ asset('images/logo.png') }}"></a></a>
      ...
      <div class="computers_section_2">
         <div class="container-fluid">
            <div class="computer_main">
               <div class="row">
                  <div class="col-md-4">
                     <div class="computer_img"><img src="{{ asset('images/computer-img.png') }}"></div>
                  ...
                  <div class="col-md-4">
                     <div class="computer_img"><img src="{{ asset('images/laptop-img.png') }}"></div>
                  ...
                  <div class="col-md-4">
                     <div class="computer_img"><img src="{{ asset('images/mac-img.png') }}"></div>
            ...
            <div class="footer_section_2">
               <div class="row">
                  ...
                  <div class="col-lg-3 col-sm-6">
                     ...
                     <div class="call_text"><img src="{{ asset('images/map-icon.png') }}"><span class="paddlin_left_0"><a href="#">London 145 United Kingdom</a></span></div>
                     <div class="call_text"><img src="{{ asset('images/call-icon.png') }}"><span class="paddlin_left_0"><a href="#">+7586656566</a></span></div>
                     <div class="call_text"><img src="{{ asset('images/mail-icon.png') }}"><span class="paddlin_left_0"><a href="#">volim@gmail.com</a></span></div>
                  </div>
               </div>
            </div>
         </div>
